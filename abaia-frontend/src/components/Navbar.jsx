  ...
  return (
    <div className="navbar bg-base-100/90 backdrop-blur-md shadow-sm border-b border-base-200 px-1 sm:px-6 lg:px-8 sticky top-0 z-50 min-h-12 sm:min-h-16">
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="btn btn-ghost text-xl font-bold gap-2 px-2 hidden sm:flex"
        >
      ...
      <div className="navbar-end gap-0">
        ...
        {!user && (
          <>
            <Link
              to="/register"
              className="btn btn-ghost btn-xs sm:btn-sm btn-square hidden sm:inline-flex"
            >
              <UserPlus size={14} />
            </Link>
            <Link
        ...
        <Link
          to="/cart"
          className="btn btn-ghost btn-xs sm:btn-sm btn-square relative"
          title={t("cart")}
        >
          <ShoppingBag size={16} />
          {totalItems > 0 && (
        ...
        {user && (
          <div className="dropdown dropdown-end">
            <button
              tabIndex={0}
              className="btn btn-ghost btn-xs sm:btn-sm px-1 sm:px-3 gap-1 sm:gap-2"
            >
              {user.profile_pic ? (
                <img
        ...
        <div className="fixed inset-0 top-14 z-40 lg:hidden">
          ...
          <div className="relative bg-base-100/95 backdrop-blur-md w-72 h-full shadow-xl flex flex-col p-5 gap-1">
            ...
            {user?.role === "admin" && (
              <Link
                to="/admin"
                className="btn btn-ghost justify-start text-lg gap-3 text-warning"
              >
            ...
            <button
              ...
              className="btn btn-ghost justify-start text-lg gap-3"
            >
            ...
            {user ? (
              <button
                ...
                className="btn btn-ghost justify-start text-lg gap-3 text-error mt-2"
              >
